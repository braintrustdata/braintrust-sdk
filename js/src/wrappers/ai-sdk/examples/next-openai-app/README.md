# AI SDK, Next.js, and OpenAI Chat Example + Braintrust

> Slightly modified from the original example. We exclude many examples/files that we didn't modify to have Braintrust tracing.
