...
/**
 * Internal auto-instrumentation consumer for the Anthropic SDK.
 *
 * This consumer subscribes to orchestrion channels for Anthropic SDK methods
 ...
 */
class AnthropicInstrumentationConsumer {
...
let anthropicInstrumentationConsumer:
  | AnthropicInstrumentationConsumer
  | undefined;

export function registerAnthropicInstrumentation(): void {
  anthropicInstrumentationConsumer ??= new AnthropicInstrumentationConsumer();
  anthropicInstrumentationConsumer.register();
}
