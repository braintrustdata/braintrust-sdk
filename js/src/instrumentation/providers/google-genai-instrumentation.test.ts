...
import { registerGoogleGenAIInstrumentation } from "./google-genai-instrumentation";
...
describe("registerGoogleGenAIInstrumentation", () => {
  let mockChannel: any;
...
describe("Google GenAI serialization functions", () => {
  describe("serializeInput", () => {
    it("should serialize basic input with model and contents", () => {
      ...
      // Since these are private functions, test them through consumer behavior.
