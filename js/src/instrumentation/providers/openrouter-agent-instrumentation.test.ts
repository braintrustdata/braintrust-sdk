...
} from "./openrouter-agent-instrumentation";
...
describe("OpenRouter Agent instrumentation", () => {
  ...
  beforeEach(() => {
    ...
    initLogger({
      projectName: "openrouter-agent-instrumentation.test.ts",
  ...
  describe("callModel tool patching", () => {
    ...
    it("supports @openrouter/agent OpenRouter.callModel(request)", async () => {
      const finalResponse = {
        id: "resp_agent",
        model: "openai/gpt-4.1-mini",
        status: "completed",
