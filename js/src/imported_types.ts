...
>;
export const ChatCompletionContentPartImage = z.object({
  image_url: z.object({
    url: z.string(),
    detail: z
...
export type ChatCompletionContentPartImageType = z.infer<
  typeof ChatCompletionContentPartImage
>;
export const ChatCompletionContentPart = z.union([
  ChatCompletionContentPartText.and(z.unknown()),
  ChatCompletionContentPartImage,
]);
export type ChatCompletionContentPartType = z.infer<
  typeof ChatCompletionContentPart
>;
export const ChatCompletionContent = z.union([
  z.string(),
  z.array(ChatCompletionContentPart),
]);
export type ChatCompletionContentType = z.infer<typeof ChatCompletionContent>;
...
export const ChatCompletionMessageParam = z.union([
  z.object({
    content: z
      .union([z.string(), z.array(ChatCompletionContentPartText)])
      .optional(),
    role: z.literal("system"),
    name: z.string().optional(),
  }),
  z.object({
    content: ChatCompletionContent.optional(),
    role: z.literal("user"),
    name: z.string().optional(),
  }),
  z.object({
    ...
    tool_calls: z
      .union([z.array(ChatCompletionMessageToolCall), z.null()])
      .optional(),
    reasoning: z
      .union([z.array(ChatCompletionMessageReasoning), z.null()])
      .optional(),
  }),
  z.object({
    content: z
...
export const PromptOptions = z.union([
  z
...
export const PromptData = z.union([
  z
    .object({
...
export const Prompt = z.object({
  ...
  description: z.union([z.string(), z.null()]).optional(),
  created: z.union([z.string(), z.null()]).optional(),
  prompt_data: PromptData.optional(),
  tags: z.union([z.array(z.string()), z.null()]).optional(),
  metadata: z
    .union([z.object({}).partial().passthrough(), z.null()])
    .optional(),
  function_type: z
    .union([z.enum(["llm", "scorer", "task", "tool"]), z.null()])
    .optional(),
});
...
export const ProjectAutomation = z.object({
  ...
  config: z.union([
    ...
    z.object({
      ...
      retention_days: z.number().gte(1).lte(365),
    }),
  ]),
});
...
export const FunctionId = z.union([
  ...
  z.object({
    inline_prompt: PromptData.and(z.object({}).partial()).optional(),
    inline_function: z.object({}).partial().passthrough(),
    function_type: z.enum(["llm", "scorer", "task", "tool"]).optional(),
    name: z.union([z.string(), z.null()]).optional(),
  }),
  z.object({
    inline_prompt: PromptData.and(z.object({}).partial()),
    function_type: z.enum(["llm", "scorer", "task", "tool"]).optional(),
    name: z.union([z.string(), z.null()]).optional(),
  }),
]);
