 ...
 *
 * This hook uses @apm-js-collab/tracing-hooks to perform AST transformation
 * at load-time for BOTH ESM and CJS modules, injecting TracingChannel calls
 * into AI SDK functions.
 *
...
try {
  // Use createRequire to synchronously load the CJS ModulePatch
