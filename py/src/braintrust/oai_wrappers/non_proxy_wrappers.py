...
# This wraps 0.*.* versions of the openai module, eg
# https://github.com/openai/openai-python/tree/v0.28.1
class OpenAIV0NonProxyWrapper(NamedWrapper):
...
class OpenAIV1NonProxyWrapper(NamedWrapper):
    def __init__(self, openai):
        super().__init__(openai)
