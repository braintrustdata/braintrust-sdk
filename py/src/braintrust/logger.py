...
from .bt_json import bt_dumps, json_safe_deep_copy
...
def _log_feedback_impl(
    ...
    update_event = json_safe_deep_copy(update_event)
...
class SpanImpl(Span):
    ...
    def log_internal(self, event: dict[str, Any] | None = None, internal_data: dict[str, Any] | None = None) -> None:
        ...
        serializable_partial_record = json_safe_deep_copy(partial_record)
...
class Dataset(ObjectFetcher[DatasetEvent]):
    ...
    def delete(self, id: str) -> str:
        ...
        partial_args = json_safe_deep_copy(partial_args)
