...
import threading
import urllib.parse
from typing import Any, Callable, Dict, Generic, List, Set, Tuple, TypeVar, Union, get_origin
...
# NOTE: The following utilities are copied to autoevals/py/autoevals/util.py.
# Keep them in sync: eprint, SerializableDataClass.
