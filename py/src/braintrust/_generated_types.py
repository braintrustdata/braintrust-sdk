...
class NullableSavedFunctionIdNullableSavedFunctionId1(TypedDict):
    type: Literal['global']
    name: str
    function_type: NotRequired[Optional[NullableFunctionTypeEnum | None]]
...
class ProjectAutomationConfig1(TypedDict):
    ...
    The type of automation.
    """
    export_definition: ProjectAutomationConfig1ExportDefinition | ProjectAutomationConfig1ExportDefinition1 | ProjectAutomationConfig1ExportDefinition2
    """
...
class ProjectSettings(TypedDict):
    ...
    """
    default_preprocessor: NotRequired[Optional[NullableSavedFunctionId | None]]
...
class PromptSessionEvent(TypedDict):
    ...
    """
    function_type: NotRequired[Optional[FunctionTypeEnumNullish | None]]
...
class RoleMemberPermission(TypedDict):
    ...
    restrict_object_type: NotRequired[Optional[AclObjectType | None]]
...
class AnyModelParams(TypedDict):
    ...
    response_format: NotRequired[Optional[ResponseFormatNullish | None]]
...
class SpanAttributes(TypedDict):
    ...
    """
    type: NotRequired[Optional[SpanType | None]]
...
class InvokeFunctionInvokeFunction7(TypedDict):
    ...
    """
    context: NotRequired[Optional[InvokeContext | None]]
    ...
    """
    mode: NotRequired[Optional[StreamingMode | None]]
    strict: NotRequired[Optional[bool | None]]
    """
...
class ProjectScore(TypedDict):
    ...
    categories: NotRequired[Optional[ProjectScoreCategories | None]]
...
class PromptData(TypedDict):
    prompt: NotRequired[Optional[PromptBlockDataNullish | None]]
...
class View(TypedDict):
    ...
    options: NotRequired[Optional[ViewOptions | None]]
    user_id: NotRequired[Optional[str | None]]
    """
