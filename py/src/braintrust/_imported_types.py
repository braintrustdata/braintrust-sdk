...
class ProjectSettings(TypedDict):
    ...
    """
    spanFieldOrder: NotRequired[Sequence[ProjectSettingsSpanFieldOrderItem]]
    """
    The order of the fields to display in the trace view
    """
    remote_eval_sources: NotRequired[Sequence[ProjectSettingsRemoteEvalSource]]
    """
...
class ChatCompletionContentPartImageImageUrl(TypedDict):
    url: str
...
class ChatCompletionMessageParamChatCompletionMessageParam(TypedDict):
    content: NotRequired[Union[str, Sequence[ChatCompletionContentPartText]]]
    role: Literal["system"]
...
class ChatCompletionMessageParamChatCompletionMessageParam2(TypedDict):
    ...
    reasoning: NotRequired[Sequence[ChatCompletionMessageReasoning]]
...
PromptBlockData = Optional[Union[PromptBlockDataPromptBlockData, PromptBlockDataPromptBlockData1]]


class ResponseFormatJsonSchema(TypedDict):
    name: str
    description: NotRequired[str]
    schema_: NotRequired[Union[Mapping[str, Any], str]]
...
class ModelParamsModelParams(TypedDict):
    ...
    function_call: NotRequired[Union[Literal["auto"], Literal["none"], ModelParamsModelParamsFunctionCall]]
    n: NotRequired[float]
...
class PromptDataParser(TypedDict):
...
class PromptData(TypedDict):
    prompt: NotRequired[PromptBlockData]
    options: NotRequired[Optional[PromptOptions]]
    parser: NotRequired[Optional[PromptDataParser]]
...
class Prompt(TypedDict):
    ...
    """
    prompt_data: NotRequired[Optional[PromptData]]
    tags: NotRequired[Sequence[str]]
    """
...
class Role(TypedDict):
    ...
    """
    member_permissions: NotRequired[Sequence[RoleMemberPermission]]
    """
...
class Prompt1Prompt1(TypedDict):
    type: Literal["completion"]
    content: str


class Prompt1Prompt11(TypedDict):
    type: Literal["chat"]
    messages: Sequence[ChatCompletionMessageParam]
    tools: NotRequired[str]


class Prompt1Prompt12(Prompt1Prompt1):
    pass


class Prompt1Prompt13(Prompt1Prompt11):
    pass


Prompt1 = Union[Prompt1Prompt12, Prompt1Prompt13]
...
class ViewOptionsViewOptionsOptions(TypedDict):
    spanType: NotRequired[Literal["range", "frame"]]
    ...
    type: NotRequired[Literal["project", "experiment"]]
...
class ViewOptionsViewOptions1(TypedDict):
    ...
    excludedMeasures: NotRequired[Sequence[ViewOptionsViewOptions1ExcludedMeasure]]
    ...
    """
    chartAnnotations: NotRequired[Sequence[ViewOptionsViewOptions1ChartAnnotation]]
...
class AnyModelParams(TypedDict):
    ...
    presence_penalty: NotRequired[float]
    response_format: NotRequired[ResponseFormat]
    tool_choice: NotRequired[Union[Literal["auto"], Literal["none"], Literal["required"], AnyModelParamsToolChoice]]
    function_call: NotRequired[Union[Literal["auto"], Literal["none"], AnyModelParamsFunctionCall]]
    n: NotRequired[float]
    stop: NotRequired[Sequence[str]]
    reasoning_effort: NotRequired[Literal["low", "medium", "high"]]
    top_k: NotRequired[float]
...
class FunctionIdFunctionId6(TypedDict):
    inline_prompt: Optional[PromptData]
    function_type: NotRequired[Literal["llm", "scorer", "task", "tool"]]
    name: NotRequired[Optional[str]]
    """
...
class Parent(TypedDict):
    ...
    """
    row_ids: NotRequired[Optional[ParentRowIds]]
    """
...
class PromptSessionEvent(TypedDict):
    ...
    Unique identifier for the prompt
    """
    prompt_session_data: NotRequired[Any]
    """
    Data about the prompt session
    """
    prompt_data: NotRequired[Any]
    """
    Data about the prompt
    """
    function_data: NotRequired[Any]
    """
    Data about the function
    """
    function_type: NotRequired[Literal["llm", "scorer", "task", "tool"]]
    object_data: NotRequired[Any]
    """
