...
def merge_row_batch(rows: List[Dict]) -> List[List[Dict]]:
    ...
    # Group together all the connected components of the undirected graph.
    ...
    # For each connected component, run topological sort over that subgraph to
    # get an ordered bucket.
