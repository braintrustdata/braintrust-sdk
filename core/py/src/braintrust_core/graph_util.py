...
def depth_first_search(
    ...
    considered. Otherwise, the visitation order is unspecified.
    """
...
def topological_sort(graph: AdjacencyListGraph, visitation_order: Optional[List[int]] = None) -> List[int]:
    ...
    "parents" to "children". It returns an ordering where parents are guaranteed
    to come before their children.
